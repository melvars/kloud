    ...
    return function t(e, n, r) {
        ...
        20: [function (e, t, n) {
            ...
            var z = e("codemirror-spell-checker"), j = e("marked"), U = /Mac/.test(navigator.platform), q = {
                ...
                bold: {name: "bold", action: c, className: "bold", title: "Bold", "default": !0},
                italic: {name: "italic", action: u, className: "italic", title: "Italic", "default": !0},
                strikethrough: {
                    name: "strikethrough",
                    action: f,
                ...
                heading: {name: "heading", action: p, className: "header", title: "Heading", "default": !0},
                "heading-smaller": {
                ...
                quote: {name: "quote", action: d, className: "icon ion-md-quote", title: "Quote", "default": !0},
                "unordered-list": {
                    name: "unordered-list",
                    action: x,
                    className: "icon ion-md-list",
                    title: "Generic List",
                    "default": !0
                },
                "ordered-list": {
                ...
                link: {name: "link", action: k, className: "icon ion-md-link", title: "Create Link", "default": !0},
                image: {
                    name: "image",
                    action: S,
                    className: "icon ion-md-photos",
                    title: "Insert Image",
                    "default": !0
                },
                ...
                "side-by-side": {
                    name: "side-by-side",
                    action: N,
                    className: "icon ion-ios-browsers",
                ...
                undo: {name: "undo", action: T, className: "icon ion-md-undo no-disable", title: "Undo"},
                redo: {name: "redo", action: M, className: "icon ion-md-redo no-disable", title: "Redo"}
            }, X = {
                link: ["[", "](#url#)"],
                image: ["![](", "#url#)"],
